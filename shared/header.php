  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="/userPanel/index.php">Rextra Pharamcy</a> </h1>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="/userPanel/user/pages-login.php">Login</a></li>
          <li><a class="nav-link scrollto" href="/userPanel/user/list-medicines.php">Medicines</a></li>
